...
{"reason": "その職業を選んだ簡潔な理由", "name": "キャラクター名", "job": "職業名", "hometown": "出身地"}
`;
...
バックストーリーには「容姿の描写」「イデオロギー/信念」「重要な人々とその理由」「意味のある場所」「秘蔵の品」「特徴」などが文中に自然な形で含まれます。
バックストーリーにはスキルの具体的な数値は含めません。
...
- MOV: ${abilityScores.mov} (7ならば低い、8ならば普通、9ならば高い)
- HP: ${abilityScores.hp} (平均的な人間は10程度)
- SAN: ${abilityScores.san} / 100
- MP: ${abilityScores.mp}
- LUCK: ${abilityScores.luck} / 100
